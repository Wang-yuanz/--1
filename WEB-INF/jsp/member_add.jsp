    ...
    <a id="aa" href="<%=basePath%>/login/member-list"></a>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="adminuname"   required=""  
          ...
          <div class="layui-form-item">
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="adminphone" name="adminphone" required="" lay-verify="nikename"
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="idno" name="idno" required="" lay-verify="nikename"
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="addrs" name="addrs" required="" lay-verify="pass"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
...
<!-- 			</form> -->
          ...
          <div class="layui-form-item">
              ...
              <input type="hidden" id="tel" value="" onclick="checkTel()">
          </div>
    </div>
    ...
    function checkTel(){
    	...
    	if(!/^(\(\d{3,4}\)|\d{3,4}-|\s)?\d{7,14}$/.test(tel)&&tel.length>0){
    	alert('固定电话有误，请重填');
    	return false;
    	}
    	}
